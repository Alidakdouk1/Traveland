...
<form method="post" action="AddFlightserverside.php" >
            ...
            <label for="DepartureDate"><b>Date of departure:</b></label> 
						<input type="datetime-local" class="form-control" id="DepartureDate" name="DepartureDate" placeholder="DepartureDate" required>
						
            <label for="ReturnDate"><b>Date of return:</b></label>
						<input type="datetime-local" class="form-control" id="ReturnDate" name="ReturnDate" placeholder="ReturnDate" required>
            ...
            <label for="Price"><b>Maximum Capacity:</b></label>
						<input type="number" class="form-control" id="capacity" name="capacity" placeholder="Capacity" required>
						
            <label for="Image" class="mt-4"><b>ImageURL:</b></label>
            <input type="file" name="fileToUpload" id="fileToUpload">
					
					<div class="form-group">
						<input type="submit" value="Add" name="SubmitAdd" id="SubmitAdd" class="btn float-right login_btn btn-warning">
            <a href="./Passengers.php"><div  class="btn float-right btn-secondary mr-2 text-warning">Back</div></a>
